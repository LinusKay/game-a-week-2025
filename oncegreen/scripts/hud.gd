...
var _messages = [
	...
	["", 10],
	["From the grave, a great colossus howls.", 5],
	["", 1],
	...
	["Thi# pl&%% was g!$een onc4", .1],
	["T#is place was gr#&^ once", .1],
	["!!!@ place was gr$#!n on)()", .1],
	["Th!% %#%!% w)( green !*()", .1],
	["##########################", .1],
	["!!!@ place was gr$#!n on)()", .1],
